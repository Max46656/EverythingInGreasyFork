...
class userStrategy extends pageStrategy{
    ...
    getAllButtonClass() {
        return ['bbWFlo','eXEEzh','fjmqoY','bbWFMD','eXEElQ','eWyraG',"bbWWZo","eXDYvt","eXeMvH","eXEGxZ","fjcIyQ","bbWEWN","bbxITk"];
    }
    getArtsCountClass(){
        return 'div.sc-a686e337-0 span';
    }
}
